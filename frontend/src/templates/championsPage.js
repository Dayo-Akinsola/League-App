...
export default async () => {
  ...
  const allOptionArrays = [sortOptions, laneOptions, roleOptions, resourceOptions];

  allOptionArrays.forEach((optionsObject) => {
  ...
  allChampionsArray.forEach((champion) => {
    const championContainer = ElementCreation.createChildElementWithClass('div', 'champion-container', championsSection);
